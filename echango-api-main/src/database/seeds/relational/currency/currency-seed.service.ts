...
export class CurrencySeedService {
  ...
  async run() {
    ...
    if (count === 0) {
      ...
      // Convert the object to an array of entities with proper property names
      const currencies = Object.values(currencyData).map((currency) => ({
        code: currency.code,
        name: currency.name,
      ...
      // Create and save all currencies
